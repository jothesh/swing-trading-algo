...
async function main() {
  console.log("");
  console.log("======================================");
  console.log("V9 BACKTEST — TUNED STRATEGY");
  console.log(`(ADX20 + 1-candle MACD + SL${V9_RISK_PARAMS.atrStopMultiplier}xATR/TG${V9_RISK_PARAMS.atrTargetMultiplier}xATR + next-open entry)`);
  console.log(`Universe: ${STOCKS.length} stocks (excluded: ${V9_EXCLUDED_STOCKS.join(", ")})`);
  console.log("======================================");
  console.log("");
  ...
  console.log("");
  console.log("======================================");
  console.log("V9 PORTFOLIO SUMMARY");
  console.log("======================================");
